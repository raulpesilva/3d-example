    ...
    <>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 'calc(100vh - 228px)' }}>
        <div style={{ flex: 1 }}>
          <Canvas
            camera={{
              position: new Vector3(4.541428930738389, 2.46001767460318, 1.6869807445158835),
              rotation: new Euler(-0.834424023301175, 0.8984613905582507, 0.7120532036612878, 'XYZ'),
            }}
          >
